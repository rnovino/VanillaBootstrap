  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        ...
        container_div.html('<a href="javascript:void(0)" class="chzn-single chzn-default btn btn-info"><span>' + this.default_text + '</span><span class="caret"></span><div><b></b></div></a><div class="chzn-drop dropdown-menu" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>');
      }
    ...
    Chosen.prototype.results_show = function() {
      var dd_top;
      if (!this.is_multiple) {
        this.selected_item.addClass("chzn-single-with-drop active");
    ...
    Chosen.prototype.results_hide = function() {
      if (!this.is_multiple) {
        this.selected_item.removeClass("chzn-single-with-drop active");
      }
      this.result_clear_highlight();
